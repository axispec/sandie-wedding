          ...
          <div className="flex flex-col items-center w-full">
            ...
            <div className="bg-[#eee] w-full flex justify-center py-[12px] border-t border-black">
              <div className="flex gap-0 max-w-[392px] w-full h-[46px] px-[16px]">
                ...
                <Link to="/wedding-drinks" className="flex-1 flex items-center justify-center">
            ...
            <div className="bg-[#eee] w-full flex flex-col items-center gap-[24px] p-[16px]">
              <p className="text-[18px] font-semibold text-center w-full">Bite Sized Canapés</p>
              <div className="bg-white border border-black rounded-[12px] max-w-[360px] w-full p-[24px]">
                <div className="flex flex-col gap-[24px]">
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-normal leading-[1.4]">Pork belly skewer with tamarind, caramel, and toasted sesame (gf) (df)</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-normal leading-[1.4]">Smoked duck with beetroot and witlof (gf) (df)</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-normal leading-[1.4]">Rare beef toasts with dijonnaise, smoked onion and watercress (gf) (df)</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-normal">Chargrilled eggplant za'atar with cashew cheese (v) (gf)</p>
                  </div>
                  <div>
                    <p className="text-[16px] font-normal leading-[1.4]">Smoked kingfish tartlet with radish remoulade</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Substantial Canapés */}
            <div className="bg-[#eee] w-full flex flex-col items-center gap-[24px] p-[16px]">
              <p className="text-[18px] font-semibold text-center w-full">Substantial Canapés</p>
              <div className="bg-white border border-black rounded-[12px] max-w-[360px] w-full p-[24px]">
                <div className="flex flex-col gap-[24px]">
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Vodka king prawn gnocchi</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Sticky pork bao buns with toasted sesame, macadamia and papaya salad</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Black bean tacos with Pico de Gallo salsa and guacamole (v) (gf)</p>
                  </div>
                  <div>
                    <p className="text-[16px] font-medium">Duck and mushroom spring rolls with black vinegar sauce (df)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Pizzas */}
            <div className="bg-[#eee] w-full flex flex-col items-center gap-[24px] p-[16px]">
              <p className="text-[18px] font-semibold text-center w-full">Pizzas</p>
              <div className="bg-white border border-black rounded-[12px] max-w-[360px] w-full p-[24px]">
                <div className="flex flex-col gap-[24px]">
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Salumi sopressa, ricotta, hot honey and oregano</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Chicken Genovese</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Potato and caramelised onion</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Potato and caramelised onion</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Prawn, capers, chilli, garlic, provolone, cherry tomatoes and rocket</p>
                  </div>
                  <div>
                    <p className="text-[16px] font-medium">Pumpkin, zucchini, macadamia pesto and vegan mozzarella (v)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Dessert */}
            <div className="bg-[#eee] w-full flex flex-col items-center gap-[24px] p-[16px]">
              <p className="text-[18px] font-semibold text-center w-full">Dessert</p>
              <div className="bg-white border border-black rounded-[12px] max-w-[360px] w-full p-[24px]">
                <div className="flex flex-col gap-[24px]">
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Tiramisu</p>
                  </div>
                  <div className="pb-[24px] border-b border-black border-dashed">
                    <p className="text-[16px] font-medium">Biscoff gelato</p>
                  </div>
                  <div>
                    <p className="text-[16px] font-medium">Lemon sorbet</p>
                  </div>
                </div>
              </div>
            </div>
