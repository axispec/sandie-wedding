import svgPaths from "./svg-wf15tadb87";

function Message({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="Message">
      ...
      <div className="absolute inset-[37.5%_16.67%_45.83%_16.67%]">
        <div className="absolute inset-[-22.36%_-2.8%_-19.1%_-2.8%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.8944 5.65836">
            <path d={svgPaths.p33a24680} id="Vector 3" stroke="var(--stroke-0, #33363F)" strokeWidth="2" />
          </svg>
        </div>
      </div>
    </div>
...
function Favorite({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="Favorite">
...
function RoadAltFill({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="Road_alt_fill">
...
function Burger({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="burger">
...
function MusicFill({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="Music_fill">
...
function Video({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="Video">
...
function Camera({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="Camera">
...
function Favorites({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="Favorites">
...
export default function Vendors({ className }: { className?: string }) {
  return (
    <div className={className || "bg-white content-stretch flex items-start overflow-clip pb-[120px] pl-px relative w-[393px]"} data-name="vendors">
      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="main">
            ...
            <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex flex-col items-center pb-[16px] pt-[80px] px-[6px] relative size-full">
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[360px]" data-name="home-heading">
                  <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[24px] text-black text-center w-full">Vendors</p>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="bg-white relative shrink-0 w-full" data-name="vendor list">
              ...
              <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="menu-list">
                <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="container">
                    <div className="bg-white h-[60px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="event-timeline-button">
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Favorite className="relative shrink-0 size-[24px]" />
                    ...
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[16px] items-center px-[24px] py-[12px] relative size-full">
                          ...
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Phone number</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative size-full">
                          <Message className="relative shrink-0 size-[24px]" />
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Email</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-[#f4f4f4] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center pb-[12px] pt-[8px] px-[24px] relative size-full">
                          <div className="bg-white flex-[1_0_0] h-[40px] min-w-px relative rounded-[12px]" data-name="button">
                            <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
                              <div className="content-stretch flex items-center justify-center px-[16px] py-[12px] relative size-full">
                                <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-black text-center whitespace-nowrap">View run sheet</p>
                              </div>
                            </div>
                  ...
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="container">
                    <div className="bg-white h-[60px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="event-timeline-button">
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Favorites className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                    ...
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[16px] items-center px-[24px] py-[12px] relative size-full">
                          ...
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">0412 653 006</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative size-full">
                          <Message className="relative shrink-0 size-[24px]" />
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">minddymakeupartist@gmail.com</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="container">
                    <div className="bg-white h-[60px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="event-timeline-button">
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Camera className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                    ...
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[16px] items-center px-[24px] py-[12px] relative size-full">
                          ...
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Phone</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative size-full">
                          <Message className="relative shrink-0 size-[24px]" />
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">hello@samwyperphotography.com</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="container">
                    <div className="bg-white h-[60px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="event-timeline-button">
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Video className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                    ...
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative size-full">
                          <Message className="relative shrink-0 size-[24px]" />
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">fiddlefigfilms@hotmail.com</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="container">
                    <div className="bg-white h-[60px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="event-timeline-button">
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <MusicFill className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                  ...
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="container">
                    <div className="bg-white h-[60px] relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="event-timeline-button">
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <RoadAltFill className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                              <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Gosels Bus Service</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Favorite className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                              <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Botanical Avenue (Sophie)</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative size-full">
                          <Message className="relative shrink-0 size-[24px]" />
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">hello@botanicalavenue.com.au</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Favorite className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                              <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Tweed Party Hire</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Favorite className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                              <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Hampton Event Hire (Melissa)</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[16px] items-center px-[24px] py-[12px] relative size-full">
                          ...
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">07 5523 9564</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative size-full">
                          <Message className="relative shrink-0 size-[24px]" />
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">sales@hamptoneventhire.com</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Favorite className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                              <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">A+J Photobooth</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-[#f4f4f4] h-[50px] relative shrink-0 w-full" data-name="mast er-run-sheet-button">
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[8px] items-center px-[24px] py-[12px] relative size-full">
                          <Message className="relative shrink-0 size-[24px]" />
                          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative">
                            <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">aplusjphotobooth@gmail.com</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Favorite className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                              <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Off the Hook (Message collector)</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex items-center px-[24px] relative size-full">
                          <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-start min-w-px relative" data-name="vendor-name">
                            <Favorite className="relative shrink-0 size-[24px]" />
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px relative" data-name="container">
                              <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[16px] text-black w-full">Michael -Venue/event support</p>
                            </div>
                          </div>
                        </div>
                      </div>
